...
DEFAULT_TEMPLATE = str(PROJECT_ROOT / "outputs" / "predictions_summary_template.xlsx")
DEFAULT_OUT = str(OUTPUT_DIR / "predictions_summary_out_nextgen.xlsx")
DEFAULT_SCHEMA = os.getenv('BUYPIPE_SCHEMA', str(CONFIG_DIR / 'col.yml'))

DEFAULT_TTL_MINUTES = int(os.getenv('BUYPIPE_TTL_MINUTES', '240'))
DEFAULT_FORCE_REFRESH = os.getenv('BUYPIPE_FORCE_REFRESH', '0') == '1'
DEFAULT_USE_DL = os.getenv('BUYPIPE_USE_DL', '1') != '0'
DEFAULT_USE_ML = os.getenv('BUYPIPE_USE_ML', '1') != '0'
DEFAULT_USE_RL = os.getenv('BUYPIPE_USE_RL', '1') != '0'
DEFAULT_SYMBOL_LIMIT = int(os.getenv('BUYPIPE_SYMBOL_LIMIT', '0'))
...
ALPHA_VANTAGE_API_KEY = "R0CPMMZ44N4IJWAD"
# === Labels / thresholds ===
STRONG_BUY_LABEL = {
    "forward_window": 30,
...
symbols = [
    ...
    "CPER", "CPNG", "CQQQ", "CRDO", "CRC", "CRNC", "CRPT", "CRM", "CRS", "CRSP", "CRSR", "CRUS",
    ...
    "DUK", "DXCM", "DXYZ", "EA", "EBAY", "EBF", "ECL", "EDU", "EEM", "EH", "EHAB",
    ...
    "HOOD", "HOV", "HPE", "HPQ", "HRB", "HRMY", "HRTG", "HSTM", "HUBS",
    "HUYA", "HUT", "HWBK", "IBM", "IBEX", "IBIT", "ICE", "IDT", "IJT", "III",
    "IMMR", "INDA", "INDS", "INFY", "INNV", "INOD", "INSE", "INTC", "INTU",
    "IONQ", "IPO", "IPGP", "IQ", "IREN", "IRDM", "IRMD", "IRTC", "ISRG", "IT", "IYR",
    "JAKK", "JBI", "JBL", "JBLU", "JD", "JMIA", "JNJ", "JOBY", "JOYY",
    "KBH", "KBR", "KC", "KD", "KELYA", "KGC", "KMT", "KOPN", "KR", "KRNT", "KTOS",
    "KWEB", "KLAC", "LAUR", "LDOS", "LRCX", "LECO", "LEN", "LEU", "LEVI", "LGIH", "LGND", "LHX", "LI",
    ...
    "RCL", "RDNT", "RDVT", "RDW", "REMX", "REPX", "RGTI", "RIGL", "RIVN", "RIOT", "RKLB",
    ...
    "ZTEK", "BHP", "RIO", "EBAY", "DDS", "HAE", "MTCH", "LMND", "PPLT", "PALL", "FXI", "EWJ", "VGK",
    "VIX", "IWM", "NVS", "CAJFF", "PENG", "AIR", "ANGO", "QQQ", "SPY", "SPCE", "NVVE", "HCKT",
    "ETN", "PWR", "EME", "FIX", "QTS", "ROK", "AIT", "RRX", "GMED", "TCOM", "HTHT", "BSKY", "RTX",
    "PL", "LHX", "EMBJ", "MOG.A", "VSAT", "NVR", "PHM", "TOL", "SSNC", "TDC", "OMCL", "AORT", "BR",
    "RDN", "MTG", "IEX", "CPER", "NOW","RIO","BHP","NEM","AEM","AES"
]
