...
symbols = ['AMBA', 'ARQQ', 'ASTS', 'BBAI', 'BTBT', 'CIFR', 'EXPE', 'INTC', 'IONQ', 'MP', 'NDAQ', 'NNE', 'OKLO', 'QBTS',
           ...
           'ARKQ', 'ARKK', 'ARKX', 'BITQ', 'BUG', 'CPER', 'CRPT', 'DXYZ', 'ESPO', 'GLD', 'HACK', 'HERO', 'IBIT', 'INDS',
           'MISL', 'NUKZ', 'PPA', 'PXH', 'QTUM', 'SHLD', 'SLV', 'WGMI', 'XOVR', 'STCE', 'COIN', 'MSTR', 'RIOT', 'MARA',
           'GBTC', 'BITO', 'BITB', 'BITW', 'HUT', 'CLSK', 'CORZ', 'BABA', 'JD', 'PDD', 'NIO', 'XPEV', 'LI', 'TCEHY',
           'BIDU', 'KWEB', 'CQQQ', 'FXI', 'MCHI', 'ASHR', 'NAIL', 'USD', 'TECL', 'TQQQ', 'SSO', 'SOXL', 'NVDL', 'NVDU',
           'CONL', 'SH', 'QID', 'CONI', 'MSTU', 'FIAT', 'GOOG', 'MSFT', 'IBM', 'NVDA', 'SPRX', 'NOC', 'BA', 'LMT',
           'RTX', 'LHX', 'HEI', 'HXL', 'ESLT', 'AVAV', 'KTOS', 'PSN', 'ERJ', 'BKSY', 'PL', 'SATL', 'SPIR', 'RDW',
           ...
           'BCO', 'BDC', 'BH', 'BK', 'BKE', 'BKNG', 'BLX', 'BMBL', 'BPOP', 'BR', 'BSET', 'BTMD', 'BVS', 'BWA',
           'BY', 'BYD', 'C', 'CASH', 'CASS', 'CBL', 'CCBG', 'CCK', 'CCSI', 'CDNS', 'CF', 'CI', 'CMCSA', 'CMRE',
           'CNXN', 'COLL', 'COR', 'CRC', 'CRSR', 'CRVL', 'CSCO', 'CSGS', 'CSV', 'CTEV', 'CTVA', 'CVS', 'DCI', 'DD',
           'DDS', 'DH', 'DLX', 'DRI', 'DUK', 'DVAX', 'EBF', 'ECL', 'EHAB', 'ELMD', 'ENS', 'ENTA', 'ESCA', 'ETD',
           'EVTC', 'F', 'FBP', 'FET', 'FFIV', 'FG', 'FLXS', 'FSBW', 'FTDR', 'FUNC', 'GCBC', 'GCI', 'GENC', 'GFF',
           'GHC', 'GILD', 'GM', 'GRBK', 'GRC', 'GS', 'GTX', 'HAE', 'HAS', 'HBT', 'HCKT', 'HCSG', 'HD', 'HFFG',
           'HIG', 'HQY', 'HRMY', 'HRTG', 'HSII', 'HSTM', 'HWBK', 'IAS', 'IBEX', 'IDT', 'III', 'INCY', 'INDV', 'INNV',
           'INSE', 'IRMD', 'IT', 'JAKK', 'JBI', 'JMSB', 'JNJ', 'KAR', 'KELYA', 'KR', 'LAUR', 'LFST', 'LGND', 'LIVN',
           'LKQ', 'LMAT', 'LOPE', 'LRN', 'LVS', 'M', 'MA', 'MANH', 'MAT', 'MAX', 'MCK', 'MCRI', 'MD', 'MDT',
           'MFIN', 'MGEE', 'MHO', 'MLI', 'MO', 'MOV', 'MPAA', 'MS', 'MSI', 'MTCH', 'MTG', 'MYE', 'NAGE', 'NATH',
           'NATR', 'NDSN', 'NECB', 'NEU', 'NFG', 'NFLX', 'NGVT', 'NHC', 'NLOP', 'NNI', 'NRC', 'NVGS', 'NXST', 'OC',
           'ODP', 'OFG', 'OIS', 'OOMA', 'OPCH', 'ORGO', 'OSBC', 'OVLY', 'OVV', 'PAG', 'PAHC', 'PAYO', 'PBH', 'PBYI',
           'PCG', 'PEBK', 'PEGA', 'PHM', 'PLUS', 'PLXS', 'PRDO', 'PRLB', 'PRVA', 'PTCT', 'QLYS', 'RAMP', 'RBCAA', 'RBKB',
           'RGP', 'RIGL', 'RRBI', 'RS', 'RSI', 'RSVR', 'SAMG', 'SBC', 'SCSC', 'SEMR',  'SFST', 'SGC', 'SIGA',
           'SIGI', 'SMP', 'SNA', 'SPFI', 'SPOK', 'SPOT', 'SPT', 'SSNC', 'STRT', 'STT', 'SUPN', 'SWX', 'SXC', 'SYF',
           'SYY', 'T', 'TALO', 'TBPH', 'TBRG', 'TCMD', 'TDC', 'TEL', 'TENB', 'THFF', 'TIGO', 'TK', 'TMUS', 'TNC',
           'TNK', 'TOL', 'TRV', 'TSBK', 'TTC', 'UNTY', 'USCB', 'UTMD', 'UVE', 'VALU', 'VICI', 'VNDA', 'VNT', 'VZ',
           'WAB', 'WAY', 'WCC', 'WEYS', 'WRLD', 'WSBF', 'WTS', 'XPRO', 'XRAY', 'ZM', 'AMD', 'GOOGL', 'AAPL', 'META',
           'AMZN', 'TSLA', 'AI', 'PLTR', 'SNOW', 'PATH', 'ROBO', 'BOTZ', 'THNQ', 'CRWD', 'ZS', 'S', 'PANW',
           'CHKP', 'CYBR', 'CIBR', 'EA', 'TTWO', 'RBLX', 'SONY', 'NERD', 'GAMR', 'NNXPF', 'BSWGF', 'ZTEK',  'GTI',
           'CVV', 'DMAT', 'SETM', 'GDX', 'GDXJ', 'PICK', 'XME', 'URA', 'DBB', 'REMX', 'LTBR', 'BWXT', 'LEU', 'CCJ',
           'CEG', 'VST', 'NLR', 'URNM', 'RVMD', 'ARM', 'RXRX', 'NNOX', 'RIVN', 'PLUG', 'SNCY', 'JBL', 'CRDO',
           'KRNT', 'ALAB', 'AAL', 'ABT', 'ACN', 'ADSK', 'AFRM', 'AIT', 'ALGN', 'ALGT', 'ALK', 'ALNT', 'AME', 'AMPL',
           'AMTM', 'APP', 'ASGN', 'ATAT', 'ATEN', 'ATHM', 'AVGO', 'AXP', 'BAH', 'BB',  'BILI', 'BL', 'BMY',
           'BOX', 'BTDR', 'BZ', 'BZH', 'CACI', 'CBOE', 'CCS', 'CEVA', 'CFLT', 'CGNX', 'CHH', 'CL', 'CNC', 'COMP',
           'CPA', 'CPAY', 'CPNG',  'CRM', 'CRNC', 'CRS', 'CRUS', 'CTLP', 'CVCO', 'CVLT', 'CW', 'CXM', 'DAL',
           'DASH', 'DCBO', 'DDD', 'DELL', 'DFH', 'DGII', 'DHI', 'DIS', 'DJT', 'DLO', 'DLR', 'DOMO', 'DRS', 'DXCM',
           'EBAY', 'EDU', 'EH', 'EMR', 'EQIX', 'ESTC',  'ETSY', 'EVGO', 'EXLS', 'EXOD', 'EXPI', 'FI', 'FICO',
           'FIS', 'FLYW', 'FMC', 'FOUR', 'FRSH', 'FSLR', 'FUBO', 'GBTG', 'GD', 'GDDY', 'GE', 'GEN', 'GLBE',
            'GOTU', 'GPN', 'GRAB', 'GRMN', 'GRND', 'GRPN', 'GRRR', 'GSK', 'GWRE', 'GXO', 'H', 'HAL', 'HCAT',
           'HGV', 'HII', 'HIMX', 'HIVE', 'HLIT', 'HLT', 'HON', 'HOOD', 'HOUS', 'HOV', 'HPE', 'HPQ', 'HRB', 'HTHT',
           'HUBS', 'HUYA', 'HYLN', 'ICE', 'IMMR', 'INFA', 'INFY', 'INOD', 'INTU', 'IPGP', 'IQ', 'IREN', 'IRTC', 'ISRG',
           'JAMF', 'JBLU', 'JMIA', 'JOYY', 'KBH', 'KBR', 'KC', 'KD', 'KMT', 'KOPN', 'LDOS', 'LECO', 'LEN',
           'LEVI', 'LGIH', 'LIND', 'LITE', 'LOGI', 'LSPD', 'LUNR', 'LUV', 'MAMA', 'MASI', 'MDB', 'MELI', 'MLNK', 'MNDY',
           'MOMO', 'MQ', 'MRCY',  'MRVL', 'MTH', 'MU', 'NBIS', 'NCNO', 'NEE', 'NEM', 'NET', 'NICE',
           'NKE', 'NMIH', 'NNDM', 'NOVT', 'NSANY', 'NTAP', 'NTCT', 'NTES', 'NTNX', 'NU', 'NVR', 'OBDC', 'OKTA', 'OMCL',
           'OPEN', 'ORCL', 'OSPN', 'OTEX', 'OUST', 'PAGS', 'PAR', 'PAY', 'PEB', 'PFE', 'PINS', 'PLTK', 'PRGS', 'PSTG',
           'PYPL', 'QCOM', 'QNCCF', 'RCL', 'RDN', 'RDNT', 'RDVT', 'RDWR', 'ROK', 'ROKU', 'RPAY', 'RPD', 'RR', 'RRX',
           'RUM', 'RXT', 'RZLV', 'SABR', 'SAIC',  'SAP', 'SDHC', 'SE', 'SERV', 'SHOP', 'SMCI', 'SMLR', 'SNAP',
           'SOFI', 'SOHU', 'SPNS', 'SSYS', 'STC', 'STNE', 'SYK', 'SYM', 'SYNA', 'TAL', 'TBCH', 'TCOM', 'TDOC',
           'TDY', 'TEM', 'TER', 'TME', 'TMHC', 'TNDM', 'TPH', 'TRI', 'TRIP', 'TRU', 'TSAT', 'TTMI', 'U', 'UAL',
           'ULCC', 'UNH', 'UTHR', 'V', 'VAC', 'VEEV', 'VIPS', 'VKTX', 'VLRS', 'VRNS', 'VRSK', 'VTEX', 'WB', 'WBTN',
           'WDAY', 'WIT', 'WIX', 'WK', 'WT', 'XMTR', 'XNET', 'XPER', 'XYZ', 'YALA', 'Z', 'ZBRA', 'ZEPP', 'ZH',
           'DAPP', 'DES', 'EEM', 'FDIG', 'FTXL', 'IJT', 'INDA', 'IPO', 'IYR', 'RZV', 'SCHA', 'SCHD', 'SCHH', 'SLYG',
           'VB', 'VBK', 'VEA', 'VTWO']
